...
They're not perfect, but Quarto [profiles](https://quarto.org/docs/projects/profiles.html) work better than what's below. I've mostly been able to [get them to work](quarto_profiles.qmd), and the issues they have are less annoying that the issues with the solution here. So, use that. I'm leaving this here because it's a bit more flexible.
