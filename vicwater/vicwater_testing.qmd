...
**STOPPED HERE** - got this working, but no cleanup.

The area from Teesdale (-38, 144 at top left to Leopold (-38.2, 144.5) should contain 5 sites.

Oh no it doesn't. It actually contains a bazillion, because there's a bunch of `stntype: "GW"`.
...
-   sort out the filters to only get HYD and VIR (or whatever the user wants)
