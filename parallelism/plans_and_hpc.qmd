...
I think I'll start similarly to some of my local parallel testing, [where I just returned process IDs](interrogatin_parallel.qmd) to see what resources are being used.
