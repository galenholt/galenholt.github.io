...
cheat_tibble <- tibble::tibble(verb = c('mutate', 'mutate','summarise', 'summarise',
                       ...
                       fix = c('.data', 'tidyselect', '.data', 'tidyselect',
                               ...
                               '.data', '.data', 'tidyselect', 'preassign NULL'))
```

A cheatsheet of what to use where. As far as I can tell, anywhere where this says `tidyselect`, if we just have a set of variable names, we can use either `tidyselect::all_of(c("v1", 'v2'))` or just `c('v1', 'v2')` (or, obviously, more complex tidyselecting).
