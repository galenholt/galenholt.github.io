...
This is very sketchy as I figure out some python testing and debug. Mostly notes for myself.
In theory, I should be able to test the package by just calling `pytest` at a terminal, but it frequently fails. I get an error 
