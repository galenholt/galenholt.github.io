...
This runs fine interactively, but when I render, everything fails. The python chunks lose what was in the previous ones, and the references to `py$` in R chunks all fail. For now I'm going to just take this off the render list until I figure out what's up.
